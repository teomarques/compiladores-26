...
define void @_fluxControl1_main_StringArray() {
  %1 = alloca i32
  %2 = alloca i32
  %3 = alloca i32
  %4 = add i32 0, 0
...
L1:
  %15 = load i32, i32* %1
  %16 = call i32 @_fluxControl1_a_int(i32 %15)
  store i32 %16, i32* %2
  br label %L3
L2:
  %17 = load i32, i32* %1
  %18 = call i32 @_fluxControl1_b_int(i32 %17)
  store i32 %18, i32* %3
  br label %L3
L3:
  %19 = load i32, i32* %2
...
define i32 @main(i32 %argc, i8** %argv) {
  ...
  call void @_fluxControl1_main_StringArray()
  ret i32 0
}
